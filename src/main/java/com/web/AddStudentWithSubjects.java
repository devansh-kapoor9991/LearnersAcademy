...
@WebServlet("/add-student-with-subjects")
public class AddStudentWithSubjects extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public AddStudentWithSubjects() {
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(session != null) {
				...
				request.getRequestDispatcher("add-student-with-subjects.html").include(request, response);
			} 
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (session != null) {
				out.print("<h3 style='color:green'>Students details with Subjects added successfully ! </h3>");
			}
