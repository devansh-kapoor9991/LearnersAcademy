...
public class deleteTeacher extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (session != null) {
				out.print("<h3 style='color:green'> Teacher data is deleted sucessfully ! </h3>");
			}
			...
			out.println("<h3 style = 'color:red'> Cannot delete the following Teacher,teacher is assigned a class already </h3>");
			e.printStackTrace();
		}
		catch (Exception e) {
